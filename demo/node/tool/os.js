...
console.log('cpu 字节序：' + os.endianness());
...
console.log('操作系统的运行时间：' + os.uptime()/(3600*24));

console.log('操作系统的cpu：' + JSON.stringify(os.cpus()));

console.log('网络接口列表:' + JSON.stringify(os.networkInterfaces()));
